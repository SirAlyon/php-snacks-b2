...
$axtiveAds = [];
foreach($ads as $activeAd){
    if ($activeAd['is_active']){
        array_push($axtiveAds, $activeAd);
    }
}
//var_dump($activeAd);
$activeAd = $axtiveAds[rand(0, (count($axtiveAds) - 1))];
var_dump($axtiveAds)
?>
